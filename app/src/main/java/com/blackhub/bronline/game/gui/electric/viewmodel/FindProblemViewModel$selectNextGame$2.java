...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.electric.viewmodel.FindProblemViewModel$selectNextGame$2", f = "FindProblemViewModel.kt", i = {}, l = {360}, m = "invokeSuspend", n = {}, s = {})
...
public final class FindProblemViewModel$selectNextGame$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ FindProblemViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FindProblemViewModel$selectNextGame$2(FindProblemViewModel findProblemViewModel, Continuation<? super FindProblemViewModel$selectNextGame$2> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new FindProblemViewModel$selectNextGame$2(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((FindProblemViewModel$selectNextGame$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
