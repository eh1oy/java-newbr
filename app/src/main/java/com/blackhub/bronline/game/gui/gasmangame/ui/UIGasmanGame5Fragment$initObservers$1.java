...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame5Fragment$initObservers$1", f = "UIGasmanGame5Fragment.kt", i = {}, l = {83}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class UIGasmanGame5Fragment$initObservers$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ UIGasmanGame5Fragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UIGasmanGame5Fragment$initObservers$1(UIGasmanGame5Fragment uIGasmanGame5Fragment, Continuation<? super UIGasmanGame5Fragment$initObservers$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new UIGasmanGame5Fragment$initObservers$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((UIGasmanGame5Fragment$initObservers$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
 ...
 */
    /* compiled from: UIGasmanGame5Fragment.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame5Fragment$initObservers$1$1", f = "UIGasmanGame5Fragment.kt", i = {}, l = {84}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame5Fragment$initObservers$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                final UIGasmanGame5Fragment uIGasmanGame5Fragment = this.this$0;
                FlowCollector<? super GasmanChildUIState> flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame5Fragment.initObservers.1.1.1
                    ...
                    public final Object emit(@NotNull GasmanChildUIState gasmanChildUIState, @NotNull Continuation<? super Unit> continuation) {
                        FragmentGasmanGame5Binding binding;
                        GasmanChildViewModel gasmanChildViewModel2;
                        if (gasmanChildUIState.getAnimateGas()) {
                            UIGasmanGame5Fragment.this.animateGas();
                            UIGasmanGame5Fragment.this.getViewModel().gasAnimated();
                        }
                        binding = UIGasmanGame5Fragment.this.getBinding();
                        ...
                        if (topPlotQuantity == 0) {
                            ...
                            binding.ivCornerPipeTopPlot3.setVisibility(0);
                        }
                        ...
                        gasmanChildViewModel2 = UIGasmanGame5Fragment.this.getGasmanChildViewModel();
