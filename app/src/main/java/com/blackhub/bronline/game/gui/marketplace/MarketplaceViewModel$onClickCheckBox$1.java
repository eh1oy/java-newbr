...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.marketplace.MarketplaceViewModel$onClickCheckBox$1", f = "MarketplaceViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
public final class MarketplaceViewModel$onClickCheckBox$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ MarketplaceViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MarketplaceViewModel$onClickCheckBox$1(MarketplaceViewModel marketplaceViewModel, Continuation<? super MarketplaceViewModel$onClickCheckBox$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new MarketplaceViewModel$onClickCheckBox$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((MarketplaceViewModel$onClickCheckBox$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        boolean isCheckBoxChecked = this.this$0.get_uiState().getValue().getBottomSheetInfo().isCheckBoxChecked();
        int hotProductCardsCanSell = this.this$0.get_uiState().getValue().getMarketplaceLimits().getHotProductCardsCanSell();
        int addsValue = this.this$0.get_uiState().getValue().getBottomSheetInfo().getAddsValue();
        int i = isCheckBoxChecked ? addsValue + 1 : addsValue - 1;
        if (hotProductCardsCanSell <= 0 && !isCheckBoxChecked && i < 0) {
            if (!this.this$0.get_uiState().getValue().isHasPlatinumVip()) {
                marketplaceActionWithJson = this.this$0.actionWithJSON;
                marketplaceActionWithJson.sendNotifyBuyVip();
            } else {
                LocalNotification localNotification = this.this$0.getLocalNotification();
                stringResource = this.this$0.stringResources;
                localNotification.showErrorNotification(stringResource.getString(R.string.marketplace_error_limits_hot_vip_text));
            }
        } else {
            ...
            copy = r4.copy((r20 & 1) != 0 ? r4.tabValue : 0, (r20 & 2) != 0 ? r4.isCheckBoxChecked : !isCheckBoxChecked, (r20 & 4) != 0 ? r4.productCount : 0, (r20 & 8) != 0 ? r4.price : 0L, (r20 & 16) != 0 ? r4.priceForAll : 0L, (r20 & 32) != 0 ? r4.priceForPublish : priceForPublish, (r20 & 64) != 0 ? this.this$0.get_uiState().getValue().getBottomSheetInfo().addsValue : i);
