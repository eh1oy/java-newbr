...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.marketplace.MarketplaceViewModel$onClickSetPrice$1", f = "MarketplaceViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
public final class MarketplaceViewModel$onClickSetPrice$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public final /* synthetic */ String $textPrice;
    public int label;
    public final /* synthetic */ MarketplaceViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MarketplaceViewModel$onClickSetPrice$1(String str, MarketplaceViewModel marketplaceViewModel, Continuation<? super MarketplaceViewModel$onClickSetPrice$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new MarketplaceViewModel$onClickSetPrice$1(this.$textPrice, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((MarketplaceViewModel$onClickSetPrice$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        copy = r3.copy((r20 & 1) != 0 ? r3.tabValue : 0, (r20 & 2) != 0 ? r3.isCheckBoxChecked : false, (r20 & 4) != 0 ? r3.productCount : productCount, (r20 & 8) != 0 ? r3.price : longOrZero, (r20 & 16) != 0 ? r3.priceForAll : ((productCount * longOrZero) * (100 - this.this$0.get_uiState().getValue().getMarketplaceLimits().getSellTax())) / 100, (r20 & 32) != 0 ? r3.priceForPublish : 0, (r20 & 64) != 0 ? this.this$0.get_uiState().getValue().getBottomSheetInfo().addsValue : 0);
