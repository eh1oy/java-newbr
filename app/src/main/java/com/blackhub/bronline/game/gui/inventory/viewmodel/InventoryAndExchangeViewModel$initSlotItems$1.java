...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.inventory.viewmodel.InventoryAndExchangeViewModel$initSlotItems$1", f = "InventoryAndExchangeViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class InventoryAndExchangeViewModel$initSlotItems$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public InventoryAndExchangeViewModel$initSlotItems$1(InventoryAndExchangeViewModel inventoryAndExchangeViewModel, JSONArray jSONArray, List<InvItems> list, int i, Continuation<? super InventoryAndExchangeViewModel$initSlotItems$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new InventoryAndExchangeViewModel$initSlotItems$1(this.this$0, this.$itemsInSlotArray, this.$allItemsFromJSON, this.$simCardNumber, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((InventoryAndExchangeViewModel$initSlotItems$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
