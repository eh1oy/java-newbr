...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$initObservers$1", f = "UIGasmanGame6Fragment.kt", i = {}, l = {81}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class UIGasmanGame6Fragment$initObservers$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ UIGasmanGame6Fragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UIGasmanGame6Fragment$initObservers$1(UIGasmanGame6Fragment uIGasmanGame6Fragment, Continuation<? super UIGasmanGame6Fragment$initObservers$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new UIGasmanGame6Fragment$initObservers$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((UIGasmanGame6Fragment$initObservers$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
 ...
 */
    /* compiled from: UIGasmanGame6Fragment.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$initObservers$1$1", f = "UIGasmanGame6Fragment.kt", i = {}, l = {82}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$initObservers$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                final UIGasmanGame6Fragment uIGasmanGame6Fragment = this.this$0;
                FlowCollector<? super GasmanChildUIState> flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment.initObservers.1.1.1
                    ...
                    public final Object emit(@NotNull GasmanChildUIState gasmanChildUIState, @NotNull Continuation<? super Unit> continuation) {
                        FragmentGasmanGame6Binding binding;
                        GasmanChildViewModel gasmanChildViewModel2;
                        if (gasmanChildUIState.getAnimateGas()) {
                            UIGasmanGame6Fragment.this.animateGas();
                            UIGasmanGame6Fragment.this.getViewModel().gasAnimated();
                        }
                        binding = UIGasmanGame6Fragment.this.getBinding();
                        ...
                        gasmanChildViewModel2 = UIGasmanGame6Fragment.this.getGasmanChildViewModel();
