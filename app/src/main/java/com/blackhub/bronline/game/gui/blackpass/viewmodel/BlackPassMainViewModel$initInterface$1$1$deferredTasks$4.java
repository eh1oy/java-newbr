...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.blackpass.viewmodel.BlackPassMainViewModel$initInterface$1$1$deferredTasks$4", f = "BlackPassMainViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
public final class BlackPassMainViewModel$initInterface$1$1$deferredTasks$4 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        T t = premiumBitmapImage;
        if (premiumBitmapImage == null) {
            application = this.this$0.application;
            t = BitmapUtilsKt.getBitmapFromZip$default(application, "img_bp_premium.png", ImageTypePathInCDNEnum.IMAGE, 0.0f, 0.0f, 24, null);
        }
        objectRef.element = t;
