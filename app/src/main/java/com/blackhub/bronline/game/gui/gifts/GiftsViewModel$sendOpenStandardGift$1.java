...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.gifts.GiftsViewModel$sendOpenStandardGift$1", f = "GiftsViewModel.kt", i = {}, l = {207}, m = "invokeSuspend", n = {}, s = {})
@SourceDebugExtension({"SMAP\nGiftsViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 GiftsViewModel.kt\ncom/blackhub/bronline/game/gui/gifts/GiftsViewModel$sendOpenStandardGift$1\n+ 2 StateFlow.kt\nkotlinx/coroutines/flow/StateFlowKt\n*L\n1#1,463:1\n230#2,5:464\n*S KotlinDebug\n*F\n+ 1 GiftsViewModel.kt\ncom/blackhub/bronline/game/gui/gifts/GiftsViewModel$sendOpenStandardGift$1\n*L\n196#1:464,5\n*E\n"})
/* loaded from: classes3.dex */
public final class GiftsViewModel$sendOpenStandardGift$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ GiftsViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GiftsViewModel$sendOpenStandardGift$1(GiftsViewModel giftsViewModel, Continuation<? super GiftsViewModel$sendOpenStandardGift$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new GiftsViewModel$sendOpenStandardGift$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((GiftsViewModel$sendOpenStandardGift$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
 ...
 */
    /* compiled from: GiftsViewModel.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.blackhub.bronline.game.gui.gifts.GiftsViewModel$sendOpenStandardGift$1$2", f = "GiftsViewModel.kt", i = {}, l = {208}, m = "invokeSuspend", n = {}, s = {})
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            giftsActionWithJSON.sendOpenGift(2);
            MutableStateFlow<? extends GiftsUiState> mutableStateFlow = this.this$0.get_uiState();
            do {
                value = mutableStateFlow.getValue();
