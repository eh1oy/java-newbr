...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.blackpass.ui.UIBlackPassActivateNew$setObservers$5", f = "UIBlackPassActivateNew.kt", i = {}, l = {219}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class UIBlackPassActivateNew$setObservers$5 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ UIBlackPassActivateNew this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UIBlackPassActivateNew$setObservers$5(UIBlackPassActivateNew uIBlackPassActivateNew, Continuation<? super UIBlackPassActivateNew$setObservers$5> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new UIBlackPassActivateNew$setObservers$5(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((UIBlackPassActivateNew$setObservers$5) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            StateFlow<Bitmap> imgDeluxeCar = activateViewModel.getImgDeluxeCar();
            Lifecycle lifecycle = this.this$0.getLifecycle();
            Intrinsics.checkNotNullExpressionValue(lifecycle, "<get-lifecycle>(...)");
            Flow flowWithLifecycle = FlowExtKt.flowWithLifecycle(imgDeluxeCar, lifecycle, Lifecycle.State.STARTED);
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.blackpass.ui.UIBlackPassActivateNew$setObservers$5.1
                ...
                public final Object emit(@Nullable Bitmap bitmap, @NotNull Continuation<? super Unit> continuation) {
                    ...
                    binding.bannerBonusIcon4.setImageBitmap(bitmap);
