...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.entertainmentsystem.ui.UIPlayersTop$setObservers$2", f = "UIPlayersTop.kt", i = {}, l = {207}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class UIPlayersTop$setObservers$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ UIPlayersTop this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UIPlayersTop$setObservers$2(UIPlayersTop uIPlayersTop, Continuation<? super UIPlayersTop$setObservers$2> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new UIPlayersTop$setObservers$2(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((UIPlayersTop$setObservers$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            SharedFlow<NickAndTopPosAndGamePointerForCurrentPlayer> infoAboutCurrentPlayer = gamesViewModel.getInfoAboutCurrentPlayer();
            ...
            FlowCollector<? super NickAndTopPosAndGamePointerForCurrentPlayer> flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.entertainmentsystem.ui.UIPlayersTop$setObservers$2.1
                ...
                public final Object emit(@NotNull NickAndTopPosAndGamePointerForCurrentPlayer nickAndTopPosAndGamePointerForCurrentPlayer, @NotNull Continuation<? super Unit> continuation) {
                    ...
                    if (nickAndTopPosAndGamePointerForCurrentPlayer.getNick().length() > 0 && (!nickAndTopPosAndGamePointerForCurrentPlayer.getTopPos().isEmpty()) && (!nickAndTopPosAndGamePointerForCurrentPlayer.getGamePointer().isEmpty())) {
                        gamesViewModel2 = UIPlayersTop.this.getGamesViewModel();
                        gamesViewModel2.generateTopList();
                    }
