...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.holidayevents.HolidayEventsViewModel$initJson$1$deferredTasksForImages$1", f = "HolidayEventsViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
public final class HolidayEventsViewModel$initJson$1$deferredTasksForImages$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        Ref.ObjectRef<Bitmap> objectRef = this.$lastChanceImage;
        application = this.this$0.application;
        objectRef.element = BitmapUtilsKt.getBitmapFromZip$default(application, this.$properties.getLastChanceImage(), ImageTypePathInCDNEnum.IMAGE, 0.0f, 0.0f, 24, null);
