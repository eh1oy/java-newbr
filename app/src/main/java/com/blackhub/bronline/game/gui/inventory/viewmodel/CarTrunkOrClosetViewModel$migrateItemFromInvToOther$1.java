...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.inventory.viewmodel.CarTrunkOrClosetViewModel$migrateItemFromInvToOther$1", f = "CarTrunkOrClosetViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
public final class CarTrunkOrClosetViewModel$migrateItemFromInvToOther$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public CarTrunkOrClosetViewModel$migrateItemFromInvToOther$1(CarTrunkOrClosetViewModel carTrunkOrClosetViewModel, int i, int i2, int i3, Continuation<? super CarTrunkOrClosetViewModel$migrateItemFromInvToOther$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new CarTrunkOrClosetViewModel$migrateItemFromInvToOther$1(this.this$0, this.$posInOther, this.$posInInv, this.$migrateValue, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((CarTrunkOrClosetViewModel$migrateItemFromInvToOther$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            try {
                ...
                mutableLiveData2 = this.this$0.mutableOtherItems;
                List list2 = (List) mutableLiveData2.getValue();
                int i2 = this.$posInOther;
                if (list != null && list2 != null) {
                    InvItems invItems2 = (InvItems) list.get(this.$posInInv);
                    ...
                    list.set(this.$posInInv, invItems2);
                    list2.set(i, updateItemAfterMigrate);
                    i2 = i;
                }
                mutableLiveData3 = this.this$0.mutableOtherPos;
