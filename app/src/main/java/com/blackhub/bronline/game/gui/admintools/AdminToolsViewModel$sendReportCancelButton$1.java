...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.admintools.AdminToolsViewModel$sendReportCancelButton$1", f = "AdminToolsViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
public final class AdminToolsViewModel$sendReportCancelButton$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public final /* synthetic */ int $buttonId;
    public int label;
    public final /* synthetic */ AdminToolsViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdminToolsViewModel$sendReportCancelButton$1(AdminToolsViewModel adminToolsViewModel, int i, Continuation<? super AdminToolsViewModel$sendReportCancelButton$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new AdminToolsViewModel$sendReportCancelButton$1(this.this$0, this.$buttonId, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((AdminToolsViewModel$sendReportCancelButton$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        AdminToolsActionWithJSON adminToolsActionWithJSON2;
        ...
        if (this.label == 0) {
            ...
            adminToolsActionWithJSON.sendButton(3, this.$buttonId);
            adminToolsActionWithJSON2 = this.this$0.actionWithJSON;
            adminToolsActionWithJSON2.sendCloseScreen();
