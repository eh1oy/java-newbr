...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.inventory.viewmodel.InventoryAndExchangeViewModel$migrateItemFromExchangeToInv$1", f = "InventoryAndExchangeViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class InventoryAndExchangeViewModel$migrateItemFromExchangeToInv$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public InventoryAndExchangeViewModel$migrateItemFromExchangeToInv$1(InventoryAndExchangeViewModel inventoryAndExchangeViewModel, int i, int i2, Continuation<? super InventoryAndExchangeViewModel$migrateItemFromExchangeToInv$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new InventoryAndExchangeViewModel$migrateItemFromExchangeToInv$1(this.this$0, this.$posFromExchange, this.$migrateValue, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((InventoryAndExchangeViewModel$migrateItemFromExchangeToInv$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
            ...
            try {
                ...
                if (list2 != null) {
                    ...
                    if (list3 != null && list != null) {
                        ...
                        mutableLiveData4 = inventoryAndExchangeViewModel.mutableNewInvPosition;
                        ...
                        mutableLiveData6 = inventoryAndExchangeViewModel.mutableMyExchangeItems;
                        mutableLiveData6.postValue(list3);
                        mutableLiveData7 = inventoryAndExchangeViewModel.mutableOldPosFromInv;
                        mutableLiveData7.postValue(list);
                        mutableLiveData8 = inventoryAndExchangeViewModel.mutableMyExchangeItemPos;
