...
import com.blackhub.bronline.databinding.FragmentGasmanGame3Binding;
...
public final class UIGasmanGame3Fragment extends BaseFragmentWithState<GasmanParentUIState, GasmanParentViewModel, FragmentGasmanGame3Binding> {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: ProcessVariables
        jadx.core.utils.exceptions.JadxRuntimeException: Method arg registers not loaded: com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$1.<init>(kotlin.jvm.functions.Function0):void, class status: GENERATED_AND_UNLOADED
        ...
        */
    public UIGasmanGame3Fragment() {
        /*
            r7 = this;
            r0 = 2131558570(0x7f0d00aa, float:1.874246E38)
            r7.<init>(r0)
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$viewModel$2 r0 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$viewModel$2
            r0.<init>()
            kotlin.LazyThreadSafetyMode r1 = kotlin.LazyThreadSafetyMode.NONE
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$1 r2 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$1
            r2.<init>()
            ...
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$2 r3 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$2
            r3.<init>()
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$3 r4 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$3
            r5 = 0
            r4.<init>()
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$4 r6 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$4
            r6.<init>()
            ...
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$gasmanChildViewModel$2 r0 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$gasmanChildViewModel$2
            r0.<init>()
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$5 r2 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$5
            r2.<init>()
            kotlin.Lazy r0 = kotlin.LazyKt__LazyJVMKt.lazy(r1, r2)
            ...
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$6 r2 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$6
            r2.<init>()
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$7 r3 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$7
            r3.<init>()
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$8 r4 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment$special$$inlined$viewModels$default$8
            r4.<init>()
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame3Fragment.<init>():void");
    }
    ...
    private final void initViewModel() {
        FragmentGasmanGame3Binding binding = getBinding();
        GasmanChildViewModel gasmanChildViewModel = getGasmanChildViewModel();
        ImageView imageView = binding.ivCornerPipeTopPlot3;
        Boolean bool = Boolean.FALSE;
        gasmanChildViewModel.initPlots(MapsKt__MapsKt.mutableMapOf(new Pair(imageView, bool), new Pair(binding.ivStraightPipeMiddlePlot1, bool), new Pair(binding.ivTeePipeBotPlot1, bool), new Pair(binding.ivTeePipeBotPlot2, bool)), 3, 1, 2);
    }

    private final void initObservers() {
        BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(this), null, null, new UIGasmanGame3Fragment$initObservers$1(this, null), 3, null);
    }
    ...
    private final List<GasmanDropAreaItem> getListOfDropAreas() {
        ...
        GasmanDropAreaTag.TEE_PIPE_LONG_90_DEGREES tee_pipe_long_90_degrees = GasmanDropAreaTag.TEE_PIPE_LONG_90_DEGREES.INSTANCE;
        List listOf = CollectionsKt__CollectionsJVMKt.listOf(Float.valueOf(90.0f));
        BOT_PLOT bot_plot = BOT_PLOT.INSTANCE;
        GasmanDropAreaItem gasmanDropAreaItem = new GasmanDropAreaItem(list, ivTeePipeDropArea1, tee_pipe_long_90_degrees, 270.0f, listOf, bot_plot);
        List<ImageView> list2 = this.botPlotListOfViews;
        ...
        GasmanDropAreaItem gasmanDropAreaItem2 = new GasmanDropAreaItem(list2, ivTeePipeDropArea2, tee_pipe, 0.0f, CollectionsKt__CollectionsJVMKt.listOf(valueOf), bot_plot);
        ...
        GasmanDropAreaItem gasmanDropAreaItem3 = new GasmanDropAreaItem(list3, ivStraightDropArea1, usual_pipe, 0.0f, CollectionsKt__CollectionsKt.listOf((Object[]) new Float[]{valueOf, Float.valueOf(180.0f)}), MIDDLE_PLOT.INSTANCE);
        ...
        return CollectionsKt__CollectionsKt.mutableListOf(gasmanDropAreaItem, gasmanDropAreaItem2, gasmanDropAreaItem3, new GasmanDropAreaItem(list4, ivCornerDropArea1, usual_pipe, 0.0f, CollectionsKt__CollectionsJVMKt.listOf(Float.valueOf(270.0f)), TOP_PLOT.INSTANCE));
    }

    @SuppressLint({"ClickableViewAccessibility"})
    private final void initPlotsOnTouchListener() {
        FragmentGasmanGame3Binding binding = getBinding();
        this.topPlotListOfViews.addAll(CollectionsKt__CollectionsKt.listOf((Object[]) new ImageView[]{binding.ivCornerPipeTopPlot3, binding.ivCornerPipeTopPlot2}));
        ...
        ImageView ivStraightPipeMiddlePlot1 = binding.ivStraightPipeMiddlePlot1;
        Intrinsics.checkNotNullExpressionValue(ivStraightPipeMiddlePlot1, "ivStraightPipeMiddlePlot1");
        list.add(ivStraightPipeMiddlePlot1);
    ...
    public final void animateGas() {
        ...
        animate.alpha(1.0f);
        animate.start();
        for (ImageView imageView : CollectionsKt__CollectionsKt.listOf((Object[]) new ImageView[]{binding.ivCornerPipeTopPlot3, binding.ivStraightPipeMiddlePlot1, binding.ivTeePipeBotPlot2, binding.ivTeePipeBotPlot1, binding.ivCornerStaticPipe1, binding.ivCornerStaticPipe2, binding.ivStraightStaticPipe1, binding.ivTeeStaticPipe1, binding.ivCornerStaticPipe3, binding.ivStraightStaticPipe2})) {
            GasmanUtils gasmanUtils = GasmanUtils.INSTANCE;
