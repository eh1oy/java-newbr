...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.entertainmentsystem.ui.UIPlayersTop$setObservers$1", f = "UIPlayersTop.kt", i = {}, l = {GpsStatusWrapper.QZSS_SVID_MIN}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class UIPlayersTop$setObservers$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ UIPlayersTop this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UIPlayersTop$setObservers$1(UIPlayersTop uIPlayersTop, Continuation<? super UIPlayersTop$setObservers$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new UIPlayersTop$setObservers$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((UIPlayersTop$setObservers$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            StateFlow<List<EntertainmentPlayersData>> allTopList = gamesViewModel.getAllTopList();
            ...
            FlowCollector<? super List<EntertainmentPlayersData>> flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.entertainmentsystem.ui.UIPlayersTop$setObservers$1.1
                ...
                public final Object emit(@NotNull List<EntertainmentPlayersData> list, @NotNull Continuation<? super Unit> continuation) {
                    ...
                    if (!list.isEmpty()) {
                        entertainmentSystemPlayersTopAdapter = UIPlayersTop.this.playersTopAdapter;
                        if (entertainmentSystemPlayersTopAdapter != null) {
                            entertainmentSystemPlayersTopAdapter.initTopPlayers(list);
                        }
                        z = UIPlayersTop.this.ifFirstShow;
                        if (z) {
                            UIPlayersTop.this.ifFirstShow = false;
                            list2 = UIPlayersTop.this.gamesList;
                            ((EntertainmentGamesFilter) list2.get(((EntertainmentPlayersData) CollectionsKt___CollectionsKt.first((List) list)).getThisGame())).setClicked(true);
                            entertainmentSystemGamesFilterAdapter = UIPlayersTop.this.gamesFilterAdapter;
