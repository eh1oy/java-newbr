...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame8Fragment$initObservers$1", f = "UIGasmanGame8Fragment.kt", i = {}, l = {83}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class UIGasmanGame8Fragment$initObservers$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ UIGasmanGame8Fragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UIGasmanGame8Fragment$initObservers$1(UIGasmanGame8Fragment uIGasmanGame8Fragment, Continuation<? super UIGasmanGame8Fragment$initObservers$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new UIGasmanGame8Fragment$initObservers$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((UIGasmanGame8Fragment$initObservers$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
 ...
 */
    /* compiled from: UIGasmanGame8Fragment.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 9, 0}, xi = 48)
    @DebugMetadata(c = "com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame8Fragment$initObservers$1$1", f = "UIGasmanGame8Fragment.kt", i = {}, l = {84}, m = "invokeSuspend", n = {}, s = {})
    /* renamed from: com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame8Fragment$initObservers$1$1, reason: invalid class name */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) {
            ...
            if (i == 0) {
                ...
                final UIGasmanGame8Fragment uIGasmanGame8Fragment = this.this$0;
                FlowCollector<? super GasmanChildUIState> flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame8Fragment.initObservers.1.1.1
                    ...
                    public final Object emit(@NotNull GasmanChildUIState gasmanChildUIState, @NotNull Continuation<? super Unit> continuation) {
                        FragmentGasmanGame8Binding binding;
                        GasmanChildViewModel gasmanChildViewModel2;
                        if (gasmanChildUIState.getAnimateGas()) {
                            UIGasmanGame8Fragment.this.animateGas();
                            UIGasmanGame8Fragment.this.getViewModel().gasAnimated();
                        }
                        binding = UIGasmanGame8Fragment.this.getBinding();
                        ...
                        gasmanChildViewModel2 = UIGasmanGame8Fragment.this.getGasmanChildViewModel();
