...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.blackpass.ui.UIBlackPassActivateNew$setObservers$1", f = "UIBlackPassActivateNew.kt", i = {}, l = {138}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class UIBlackPassActivateNew$setObservers$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ UIBlackPassActivateNew this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UIBlackPassActivateNew$setObservers$1(UIBlackPassActivateNew uIBlackPassActivateNew, Continuation<? super UIBlackPassActivateNew$setObservers$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new UIBlackPassActivateNew$setObservers$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((UIBlackPassActivateNew$setObservers$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            StateFlow<Integer> premiumPrice = activateViewModel.getPremiumPrice();
            Lifecycle lifecycle = this.this$0.getLifecycle();
            Intrinsics.checkNotNullExpressionValue(lifecycle, "<get-lifecycle>(...)");
            Flow flowWithLifecycle = FlowExtKt.flowWithLifecycle(premiumPrice, lifecycle, Lifecycle.State.STARTED);
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.blackpass.ui.UIBlackPassActivateNew$setObservers$1.1
                ...
                public final Object emit(int i2, @NotNull Continuation<? super Unit> continuation) {
                    ...
                    z = UIBlackPassActivateNew.this.isActivePremium;
                    if (!z) {
                        UIBlackPassActivateNew uIBlackPassActivateNew2 = UIBlackPassActivateNew.this;
                        ...
                        UIBlackPassActivateNew.this.premiumPrice = i2;
                        binding = UIBlackPassActivateNew.this.getBinding();
                        binding.btnPurchasePremium.setEnabled(true);
                    }
