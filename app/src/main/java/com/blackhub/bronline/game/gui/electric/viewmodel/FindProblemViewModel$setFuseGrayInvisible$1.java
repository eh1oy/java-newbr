...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.electric.viewmodel.FindProblemViewModel$setFuseGrayInvisible$1", f = "FindProblemViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
public final class FindProblemViewModel$setFuseGrayInvisible$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public FindProblemViewModel$setFuseGrayInvisible$1(CurrentTargetArea currentTargetArea, FindProblemViewModel findProblemViewModel, Continuation<? super FindProblemViewModel$setFuseGrayInvisible$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new FindProblemViewModel$setFuseGrayInvisible$1(this.$currentTargetArea, this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((FindProblemViewModel$setFuseGrayInvisible$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
