...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.fractions.GUIFractionSystem$setObservers$1", f = "GUIFractionSystem.kt", i = {}, l = {TsExtractor.TS_PACKET_SIZE}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class GUIFractionSystem$setObservers$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ GUIFractionSystem this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GUIFractionSystem$setObservers$1(GUIFractionSystem gUIFractionSystem, Continuation<? super GUIFractionSystem$setObservers$1> continuation) {
        super(2, continuation);
        this.this$0 = gUIFractionSystem;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new GUIFractionSystem$setObservers$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((GUIFractionSystem$setObservers$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            final GUIFractionSystem gUIFractionSystem = this.this$0;
            FlowCollector flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.fractions.GUIFractionSystem$setObservers$1.1
                ...
                public final Object emit(@NotNull ConfigurationJsonModel configurationJsonModel, @NotNull Continuation<? super Unit> continuation) {
                    ...
                    documentsViewModel = GUIFractionSystem.this.getDocumentsViewModel();
                    documentsViewModel.getDocumentsAndTestingLists(configurationJsonModel.getFractionDocuments());
                    shopViewModel = GUIFractionSystem.this.getShopViewModel();
                    shopViewModel.getShopList(configurationJsonModel.getFractionShopList());
                    questsViewModel = GUIFractionSystem.this.getQuestsViewModel();
                    questsViewModel.getQuestsObj(configurationJsonModel.getFractionQuestsObj());
