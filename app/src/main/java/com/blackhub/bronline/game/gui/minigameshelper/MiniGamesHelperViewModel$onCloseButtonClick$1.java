...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.minigameshelper.MiniGamesHelperViewModel$onCloseButtonClick$1", f = "MiniGamesHelperViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
public final class MiniGamesHelperViewModel$onCloseButtonClick$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ MiniGamesHelperViewModel this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MiniGamesHelperViewModel$onCloseButtonClick$1(MiniGamesHelperViewModel miniGamesHelperViewModel, Continuation<? super MiniGamesHelperViewModel$onCloseButtonClick$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new MiniGamesHelperViewModel$onCloseButtonClick$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((MiniGamesHelperViewModel$onCloseButtonClick$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            MiniGamesHelperViewModel miniGamesHelperViewModel = this.this$0;
