...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.entertainmentsystem.ui.UIGamesLayout$setObservers$1", f = "UIGamesLayout.kt", i = {}, l = {88}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class UIGamesLayout$setObservers$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ UIGamesLayout this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UIGamesLayout$setObservers$1(UIGamesLayout uIGamesLayout, Continuation<? super UIGamesLayout$setObservers$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new UIGamesLayout$setObservers$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((UIGamesLayout$setObservers$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            SharedFlow<List<EntertainmentGameData>> allGames = gamesViewModel.getAllGames();
            final UIGamesLayout uIGamesLayout = this.this$0;
            FlowCollector<? super List<EntertainmentGameData>> flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.entertainmentsystem.ui.UIGamesLayout$setObservers$1.1
            ...
            this.label = 1;
            if (allGames.collect(flowCollector, this) == coroutine_suspended) {
