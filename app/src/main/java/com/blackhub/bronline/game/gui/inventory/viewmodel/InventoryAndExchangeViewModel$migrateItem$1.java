...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.inventory.viewmodel.InventoryAndExchangeViewModel$migrateItem$1", f = "InventoryAndExchangeViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class InventoryAndExchangeViewModel$migrateItem$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public InventoryAndExchangeViewModel$migrateItem$1(InventoryAndExchangeViewModel inventoryAndExchangeViewModel, int i, int i2, Continuation<? super InventoryAndExchangeViewModel$migrateItem$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new InventoryAndExchangeViewModel$migrateItem$1(this.this$0, this.$newPosition, this.$oldPosition, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((InventoryAndExchangeViewModel$migrateItem$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        if (this.label == 0) {
            ...
            try {
                ...
                if (list != null) {
                    ...
                    mutableLiveData3 = inventoryAndExchangeViewModel.mutableNewInvPosition;
