...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.donate.GUIDonate$setObservers$14", f = "GUIDonate.kt", i = {}, l = {895}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class GUIDonate$setObservers$14 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ GUIDonate this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GUIDonate$setObservers$14(GUIDonate gUIDonate, Continuation<? super GUIDonate$setObservers$14> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new GUIDonate$setObservers$14(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((GUIDonate$setObservers$14) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            SharedFlow<PreviewPrize> gettingPrize = donateViewModel.getGettingPrize();
            Lifecycle lifecycle = this.this$0.getLifecycle();
            Intrinsics.checkNotNullExpressionValue(lifecycle, "<get-lifecycle>(...)");
            Flow flowWithLifecycle = FlowExtKt.flowWithLifecycle(gettingPrize, lifecycle, Lifecycle.State.STARTED);
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.donate.GUIDonate$setObservers$14.1
                ...
                public final Object emit(@NotNull PreviewPrize previewPrize, @NotNull Continuation<? super Unit> continuation) {
                    if (previewPrize.getTypeOfAward() == 0 || previewPrize.getTypeOfAward() == 4) {
                        GUIDonate.this.startActionForTypeOfInterface(previewPrize);
                    }
                    ComposeView composeView = GUIDonate.access$getBinding(GUIDonate.this).composeViewSecondDonateFullScreen;
                    composeView.setContent(ComposableSingletons$GUIDonateKt.INSTANCE.m6891getLambda3$app_siteRelease());
