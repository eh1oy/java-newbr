...
public final class UIGasmanGame6Fragment extends BaseFragmentWithState<GasmanParentUIState, GasmanParentViewModel, FragmentGasmanGame6Binding> {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: ProcessVariables
        jadx.core.utils.exceptions.JadxRuntimeException: Method arg registers not loaded: com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$1.<init>(kotlin.jvm.functions.Function0):void, class status: GENERATED_AND_UNLOADED
    ...
    public UIGasmanGame6Fragment() {
        /*
            ...
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$viewModel$2 r0 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$viewModel$2
            r0.<init>()
            kotlin.LazyThreadSafetyMode r1 = kotlin.LazyThreadSafetyMode.NONE
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$1 r2 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$1
            r2.<init>()
            ...
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$2 r3 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$2
            r3.<init>()
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$3 r4 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$3
            r5 = 0
            r4.<init>()
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$4 r6 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$4
            r6.<init>()
            kotlin.Lazy r0 = androidx.fragment.app.FragmentViewModelLazyKt.createViewModelLazy(r7, r2, r3, r4, r6)
            r7.viewModel = r0
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$gasmanChildViewModel$2 r0 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$gasmanChildViewModel$2
            r0.<init>()
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$5 r2 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$5
            r2.<init>()
            kotlin.Lazy r0 = kotlin.LazyKt__LazyJVMKt.lazy(r1, r2)
            ...
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$6 r2 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$6
            r2.<init>()
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$7 r3 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$7
            r3.<init>()
            com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$8 r4 = new com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment$special$$inlined$viewModels$default$8
            r4.<init>()
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blackhub.bronline.game.gui.gasmangame.ui.UIGasmanGame6Fragment.<init>():void");
    }
    ...
    private final void initObservers() {
        BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(this), null, null, new UIGasmanGame6Fragment$initObservers$1(this, null), 3, null);
    }
    ...
    private final List<GasmanDropAreaItem> getListOfDropAreas() {
        ...
        List listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new Float[]{valueOf, valueOf2});
        MIDDLE_PLOT middle_plot = MIDDLE_PLOT.INSTANCE;
        GasmanDropAreaItem gasmanDropAreaItem = new GasmanDropAreaItem(list, ivStraightDropArea1, straight_long_pipe_90_degrees, 90.0f, listOf, middle_plot);
        ...
        GasmanDropAreaItem gasmanDropAreaItem2 = new GasmanDropAreaItem(list2, ivStraightDropArea2, straight_long_pipe_90_degrees, 270.0f, CollectionsKt__CollectionsKt.listOf((Object[]) new Float[]{valueOf3, Float.valueOf(270.0f)}), middle_plot);
        ...
        GasmanDropAreaItem gasmanDropAreaItem3 = new GasmanDropAreaItem(list3, ivCornerDropArea1, GasmanDropAreaTag.USUAL_PIPE.INSTANCE, 180.0f, CollectionsKt__CollectionsJVMKt.listOf(valueOf3), TOP_PLOT.INSTANCE);
        ...
        List listOf2 = CollectionsKt__CollectionsJVMKt.listOf(valueOf2);
        BOT_PLOT bot_plot = BOT_PLOT.INSTANCE;
        GasmanDropAreaItem gasmanDropAreaItem4 = new GasmanDropAreaItem(list4, ivTeePipeDropArea1, tee_pipe, 180.0f, listOf2, bot_plot);
        ...
        return CollectionsKt__CollectionsKt.mutableListOf(gasmanDropAreaItem, gasmanDropAreaItem2, gasmanDropAreaItem3, gasmanDropAreaItem4, new GasmanDropAreaItem(list5, ivTeePipeDropArea2, tee_pipe, 180.0f, CollectionsKt__CollectionsJVMKt.listOf(valueOf), bot_plot));
    }
