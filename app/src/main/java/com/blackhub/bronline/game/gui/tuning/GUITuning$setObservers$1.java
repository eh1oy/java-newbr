...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.tuning.GUITuning$setObservers$1", f = "GUITuning.kt", i = {}, l = {378}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class GUITuning$setObservers$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ GUITuning this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GUITuning$setObservers$1(GUITuning gUITuning, Continuation<? super GUITuning$setObservers$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new GUITuning$setObservers$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((GUITuning$setObservers$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        if (i == 0) {
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.tuning.GUITuning$setObservers$1.1
                ...
                public final Object emit(@NotNull ConfigurationJsonModel configurationJsonModel, @NotNull Continuation<? super Unit> continuation) {
                    ...
                    colorListViewModel = GUITuning.this.getColorListViewModel();
                    colorListViewModel.setColorItemsFromJson(configurationJsonModel.getCarColorItems());
