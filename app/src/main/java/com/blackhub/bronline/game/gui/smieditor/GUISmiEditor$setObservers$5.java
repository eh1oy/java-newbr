...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.smieditor.GUISmiEditor$setObservers$5", f = "GUISmiEditor.kt", i = {}, l = {210}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class GUISmiEditor$setObservers$5 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    public int label;
    public final /* synthetic */ GUISmiEditor this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GUISmiEditor$setObservers$5(GUISmiEditor gUISmiEditor, Continuation<? super GUISmiEditor$setObservers$5> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new GUISmiEditor$setObservers$5(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((GUISmiEditor$setObservers$5) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            SharedFlow<List<SmiEditorBodyObj>> newSecondColumn = smiEditorViewModel.getNewSecondColumn();
            Lifecycle lifecycle = this.this$0.getLifecycle();
            Intrinsics.checkNotNullExpressionValue(lifecycle, "<get-lifecycle>(...)");
            Flow flowWithLifecycle = FlowExtKt.flowWithLifecycle(newSecondColumn, lifecycle, Lifecycle.State.STARTED);
            ...
            FlowCollector flowCollector = new FlowCollector() { // from class: com.blackhub.bronline.game.gui.smieditor.GUISmiEditor$setObservers$5.1
                ...
                public final Object emit(@NotNull List<SmiEditorBodyObj> list, @NotNull Continuation<? super Unit> continuation) {
                    GUISmiEditor.this.initSecondColumn(list);
