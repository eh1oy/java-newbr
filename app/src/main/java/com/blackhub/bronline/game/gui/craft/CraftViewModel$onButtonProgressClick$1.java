...
@DebugMetadata(c = "com.blackhub.bronline.game.gui.craft.CraftViewModel$onButtonProgressClick$1", f = "CraftViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
@SourceDebugExtension({"SMAP\nCraftViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CraftViewModel.kt\ncom/blackhub/bronline/game/gui/craft/CraftViewModel$onButtonProgressClick$1\n+ 2 StateFlow.kt\nkotlinx/coroutines/flow/StateFlowKt\n*L\n1#1,1753:1\n230#2,5:1754\n*S KotlinDebug\n*F\n+ 1 CraftViewModel.kt\ncom/blackhub/bronline/game/gui/craft/CraftViewModel$onButtonProgressClick$1\n*L\n819#1:1754,5\n*E\n"})
/* loaded from: classes3.dex */
public final class CraftViewModel$onButtonProgressClick$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public CraftViewModel$onButtonProgressClick$1(CraftViewModel craftViewModel, ButtonAnimatedAttachment buttonAnimatedAttachment, Continuation<? super CraftViewModel$onButtonProgressClick$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new CraftViewModel$onButtonProgressClick$1(this.this$0, this.$buttonAnimatedAttachment, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((CraftViewModel$onButtonProgressClick$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            String string = stringResource.getString(R.string.common_add);
            ...
            while (true) {
                ...
                CraftScreenTypeObject craftScreenTypeObject = new CraftScreenTypeObject(bitmap, stringResource2.getString(R.string.craft_process));
