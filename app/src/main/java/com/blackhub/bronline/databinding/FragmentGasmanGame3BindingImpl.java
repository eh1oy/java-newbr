...
public class FragmentGasmanGame3BindingImpl extends FragmentGasmanGame3Binding {
    ...
    public FragmentGasmanGame3BindingImpl(@Nullable DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, ViewDataBinding.mapBindings(bindingComponent, root, 32, sIncludes, sViewsWithIds));
    }

    public FragmentGasmanGame3BindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    */
    public void executeBindings() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blackhub.bronline.databinding.FragmentGasmanGame3BindingImpl.executeBindings():void");
    }
}
