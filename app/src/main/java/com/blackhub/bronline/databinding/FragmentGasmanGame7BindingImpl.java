...
public class FragmentGasmanGame7BindingImpl extends FragmentGasmanGame7Binding {
    ...
    public FragmentGasmanGame7BindingImpl(@Nullable DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, ViewDataBinding.mapBindings(bindingComponent, root, 28, sIncludes, sViewsWithIds));
    }

    public FragmentGasmanGame7BindingImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1, (ConstraintLayout) bindings[0], (Guideline) bindings[19], (ImageView) bindings[23], (ImageView) bindings[16], (ImageView) bindings[18], (ImageView) bindings[1], (ImageView) bindings[2], (ImageView) bindings[3], (ImageView) bindings[12], (ImageView) bindings[14], (ImageView) bindings[17], (ImageView) bindings[26], (ImageView) bindings[27], (ImageView) bindings[25], (ImageView) bindings[24], (ImageView) bindings[13], (ImageView) bindings[4], (ImageView) bindings[5], (ImageView) bindings[6], (ImageView) bindings[11], (ImageView) bindings[7], (ImageView) bindings[8], (ImageView) bindings[9], (ImageView) bindings[10], (ImageView) bindings[15], (TextView) bindings[22], (TextView) bindings[21], (TextView) bindings[20]);
        this.mDirtyFlags = -1L;
    ...
    @Override // com.blackhub.bronline.databinding.FragmentGasmanGame7Binding
    ...
    */
    public void executeBindings() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blackhub.bronline.databinding.FragmentGasmanGame7BindingImpl.executeBindings():void");
    }
}
