...
public abstract class FragmentGasmanGame4Binding extends ViewDataBinding {
    ...
    @NonNull
    public final Barrier barrierVerticalTop;
    ...
    public FragmentGasmanGame4Binding(Object _bindingComponent, View _root, int _localFieldCount, Barrier barrierVerticalTop, ConstraintLayout containerRoot, Guideline guidelineHorizontalTop, Guideline guidelineVertical16Percent, ImageView ivAnimationGas, ImageView ivCornerDropArea1, ImageView ivCornerDropArea2, ImageView ivCornerPipeTopPlot, ImageView ivCornerPipeTopPlot1, ImageView ivCornerPipeTopPlot2, ImageView ivCornerStaticPipe1, ImageView ivCornerStaticPipe2, ImageView ivCornerStaticPipe3, ImageView ivEndArrows1, ImageView ivEndPoint, ImageView ivStartArrows, ImageView ivStartPoint, ImageView ivStraightPipeMiddlePlot, ImageView ivStraightPipeMiddlePlot1, ImageView ivStraightStaticPipe1, ImageView ivStraightStaticPipe2, ImageView ivTeePipeBotPlot, ImageView ivTeePipeBotPlot1, ImageView ivTeePipeBotPlot2, ImageView ivTeePipeDropArea1, ImageView ivTeePipeDropArea2, TextView tvBotPlot, TextView tvMiddlePlot, TextView tvTopPlot) {
        super(_bindingComponent, _root, _localFieldCount);
        this.barrierVerticalTop = barrierVerticalTop;
    ...
    @NonNull
    public static FragmentGasmanGame4Binding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup root, boolean attachToRoot) {
        return inflate(inflater, root, attachToRoot, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    @Deprecated
    public static FragmentGasmanGame4Binding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
        return (FragmentGasmanGame4Binding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_gasman_game_4, root, attachToRoot, component);
    }

    @NonNull
    public static FragmentGasmanGame4Binding inflate(@NonNull LayoutInflater inflater) {
        return inflate(inflater, DataBindingUtil.getDefaultComponent());
    }

    @NonNull
    @Deprecated
    public static FragmentGasmanGame4Binding inflate(@NonNull LayoutInflater inflater, @Nullable Object component) {
        return (FragmentGasmanGame4Binding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_gasman_game_4, null, false, component);
    }

    public static FragmentGasmanGame4Binding bind(@NonNull View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static FragmentGasmanGame4Binding bind(@NonNull View view, @Nullable Object component) {
        return (FragmentGasmanGame4Binding) ViewDataBinding.bind(component, view, R.layout.fragment_gasman_game_4);
    }
}
