...
public class FragmentGasmanGame3BindingSw600dpNotlongImpl extends FragmentGasmanGame3Binding {
    ...
    public FragmentGasmanGame3BindingSw600dpNotlongImpl(@Nullable DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, ViewDataBinding.mapBindings(bindingComponent, root, 32, sIncludes, sViewsWithIds));
    }

    public FragmentGasmanGame3BindingSw600dpNotlongImpl(DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    */
    public void executeBindings() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blackhub.bronline.databinding.FragmentGasmanGame3BindingSw600dpNotlongImpl.executeBindings():void");
    }
}
