...
public abstract class FragmentGasmanGame3Binding extends ViewDataBinding {
    ...
    public FragmentGasmanGame3Binding(Object _bindingComponent, View _root, int _localFieldCount, ConstraintLayout containerRoot, Guideline guidelineHorizontalTop, Guideline guidelineVertical16Percent, ImageView ivAnimationGas, ImageView ivCornerDropArea1, ImageView ivCornerPipeTopPlot, ImageView ivCornerPipeTopPlot1, ImageView ivCornerPipeTopPlot2, ImageView ivCornerPipeTopPlot3, ImageView ivCornerStaticPipe1, ImageView ivCornerStaticPipe2, ImageView ivCornerStaticPipe3, ImageView ivEndArrows1, ImageView ivEndArrows2, ImageView ivEndPoint, ImageView ivStartArrows, ImageView ivStartPoint, ImageView ivStraightDropArea1, ImageView ivStraightPipeMiddlePlot, ImageView ivStraightPipeMiddlePlot1, ImageView ivStraightStaticPipe1, ImageView ivStraightStaticPipe2, ImageView ivTeePipeBotPlot, ImageView ivTeePipeBotPlot1, ImageView ivTeePipeBotPlot2, ImageView ivTeePipeDropArea1, ImageView ivTeePipeDropArea2, ImageView ivTeeStaticPipe1, TextView tvBotPlot, TextView tvEndPoint, TextView tvMiddlePlot, TextView tvTopPlot) {
    ...
    @NonNull
    public static FragmentGasmanGame3Binding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup root, boolean attachToRoot) {
    ...
    public static FragmentGasmanGame3Binding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
        return (FragmentGasmanGame3Binding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_gasman_game_3, root, attachToRoot, component);
    }

    @NonNull
    public static FragmentGasmanGame3Binding inflate(@NonNull LayoutInflater inflater) {
    ...
    public static FragmentGasmanGame3Binding inflate(@NonNull LayoutInflater inflater, @Nullable Object component) {
        return (FragmentGasmanGame3Binding) ViewDataBinding.inflateInternal(inflater, R.layout.fragment_gasman_game_3, null, false, component);
    }

    public static FragmentGasmanGame3Binding bind(@NonNull View view) {
        return bind(view, DataBindingUtil.getDefaultComponent());
    }

    @Deprecated
    public static FragmentGasmanGame3Binding bind(@NonNull View view, @Nullable Object component) {
        return (FragmentGasmanGame3Binding) ViewDataBinding.bind(component, view, R.layout.fragment_gasman_game_3);
    }
}
